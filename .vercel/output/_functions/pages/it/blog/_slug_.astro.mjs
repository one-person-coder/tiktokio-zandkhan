...
import { g as getLangFromUrl, $ as $$Layout, b as $$Icon, a as getRelativeLocaleUrl } from '../../../chunks/Layout_BbuZyOrx.mjs';
...
async function getStaticPaths() {
  ...
  const localizedBlogEntries = blogEntries.filter(
    (entry) => entry.slug && entry.slug.startsWith("it/")
  );
...
}, "/home/hussain/zandkhqastro-main/src/pages/it/blog/[slug].astro", void 0);

const $$file = "/home/hussain/zandkhqastro-main/src/pages/it/blog/[slug].astro";
const $$url = "/it/blog/[slug]";
